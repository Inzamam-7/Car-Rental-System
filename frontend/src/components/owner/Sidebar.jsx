...
const Sidebar = () => {
  ...
  return (
    <div className='relative min-h-screen md:screen md:flex flex-col items-center pt-8 max-w-13 md:max-w-60 w-full border-r border-borderColor text-sm'>
        <div className='group relative'>
            <label htmlFor='image'>
                <img src={image ? URL.createObjectURL(image) : user?.image || "https://t4.ftcdn.net/jpg/02/29/75/83/240_F_229758328_7x8jwCwjtBMmC6rgFzLFhZoEpLobB6L8.jpg"} className='h-9 md:h-14 w-9 md:w-14 rounded-full mx-auto'/>
        ...
        {/* <p className='mt-2 text-base max-md:hidden'>{user?.image}</p> */}
