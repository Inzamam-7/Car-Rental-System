...
const MyBookings = () => {
  ...
  const {axios, user,currencyy} = useAppContext()
 ...
 const fetchBookings = async() =>{
  try{
    ...
    if(data.success){
     ...
     // console.log(bookings.data.price);
      console.log(data);
 ...
 useEffect(() =>{
  ...
  return (
    ...
    subTitle="View manage your all car bookings"
    align="left"
    />
      ...
      {bookings.map((booking,index) =>(
        ...
        <div className='md:col-span-1 flex flex-col justify-between gap-6'>
            <div className='text-sm text-gray-500 text-right'>
              <p>Total Price</p>
              <h1 className='text-2xl font-semibold text-primary'>{currencyy}{booking.price}</h1>
