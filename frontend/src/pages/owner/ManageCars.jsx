...
const ManageCars = () => {
  ...
  const deleteCar = async(carId) =>{
    try{
        ...
        console.log("yeh delete car data h",data);
          ...
          {cars.map((car,index) =>(
            <tr key={index} className='border-t border-borderColor'>
              ...
              <td className='flex items-center p-3'>
                  <img onClick={() =>toggleAvailablility(car._id)} src={car.isAvaliable ? assets.eye_close_icon : assets.eye_icon} className='cursor-pointer'/>
